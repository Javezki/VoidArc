...
public abstract class CorruptedItem {
    ...
    {
        return Component.text(display, TextColor.color(178, 34, 34))
    ...
    {  
        ...
        {
            lore.add(Component.text(rawLoreLine, TextColor.color(178, 34, 34))
            .decoration(TextDecoration.ITALIC, false));
        }
        return lore;
    }
