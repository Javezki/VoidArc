package com.javezki.Factions.GeneralFaction.GeneralItems.GeneralItems;
...
public class GeneralItems {
    ...
    {
        return Component.text(display, TextColor.color(192, 192, 192))
    ...
    {  
        ...
        {
            lore.add(Component.text(rawLoreLine, TextColor.color(192, 192, 192))
            .decoration(TextDecoration.ITALIC, false));
        }
        return lore;
    }
